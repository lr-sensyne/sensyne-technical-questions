    ...
    return (
        <div>
            ...
            <Typography variant="body1" gutterBottom>
                If you started this application with 'yarn start' a json server
                should now be running on port 3001
            </Typography>
            <Typography variant="body1" gutterBottom>
            ...
            <Typography variant="body1" gutterBottom>
                ...
                (displayed on the right and in the console) so that the card
                component displays the data from the API.
            </Typography>
            <Typography variant="body1" gutterBottom>
